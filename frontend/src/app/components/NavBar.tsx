              ...
              <div className="flex flex-col h-full bg-gradient-to-b from-neutral-900 to-neutral-950">
                ...
                <div className="flex-1 px-6 py-6 space-y-2 overflow-y-auto">
                  <Link 
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <svg className="w-5 h-5 mr-3 text-neutral-400 group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-6 border-t border-neutral-700/50 bg-neutral-900/80">
                  {user ? (
                    <div className="space-y-3">
                      ...
                      <button 
                        onClick={handleLogout} 
                        className="flex items-center w-full px-4 py-3 text-red-400 hover:bg-red-500/10 hover:text-red-300 rounded-xl transition-all duration-200 group"
                      >
                        <svg className="w-5 h-5 mr-3 text-red-400 group-hover:text-red-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-3">
                      ...
                      <Link 
                        href="/signup" 
                        className="flex items-center justify-center w-full bg-cyan-500 text-black py-3 rounded-xl font-semibold hover:bg-cyan-400 transition-all duration-200 group"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
