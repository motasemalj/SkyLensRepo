      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden fixed inset-0 z-50 animate-fadeIn">
            ...
            {/* Menu Panel */}
            <div className="absolute top-0 right-0 h-full w-[280px] max-w-[85vw] bg-neutral-900/98 backdrop-blur-xl border-l border-cyan-500/30 shadow-2xl animate-slideInRight">
              <div className="flex flex-col h-full bg-gradient-to-b from-neutral-900 to-neutral-950">
                {/* Menu Header */}
                <div className="flex items-center justify-between p-4 border-b border-neutral-700/50 bg-neutral-900/80">
                ...
                <div className="flex-1 px-4 py-4 space-y-1">
                  <Link 
                    href="/" 
                    className="flex items-center px-3 py-2.5 text-white hover:bg-cyan-500/10 hover:text-cyan-400 rounded-lg transition-all duration-200 group"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <svg className="w-4 h-4 mr-2.5 text-neutral-400 group-hover:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Auth Section */}
                <div className="p-4 border-t border-neutral-700/50 bg-neutral-900/80 space-y-1">
                  {user ? (
                    <>
                      {!user.isAdmin && (
                        <Link 
                      ...
                      <button 
                        onClick={handleLogout} 
                        className="flex items-center w-full px-3 py-2.5 text-red-400 hover:bg-red-500/10 hover:text-red-300 rounded-lg transition-all duration-200 group"
                      >
                        <svg className="w-4 h-4 mr-2.5 text-red-400 group-hover:text-red-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
